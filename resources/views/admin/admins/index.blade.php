...
<div class="container px-4 py-8 mx-auto">
    <div class="mx-auto max-w-7xl">
        <div class="bg-white rounded-lg shadow-lg">
            ...
            <div class="p-6">
                <a href="{{ route('admin.admins.create') }}" class="inline-block px-3 py-2 mb-3 text-sm text-white bg-blue-500 rounded hover:bg-blue-600">Create</a>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('admin.admins.edit', $model->id) }}" class="px-3 py-1 text-sm text-white bg-blue-500 rounded hover:bg-blue-600">Edit</a>
                                        <form action="{{ route('admin.admins.destroy', $model->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
